 ...
 * author: SilunWang
 * date: 2013-12-19
 * description: modified from minimad.c
 * compile: gcc mp3player -o mp3player.c -lmad -lasound
 * run: ./mp3player XXX.mp3 XXX.pcm
 */ 
                     ...
                     struct mad_pcm *pcm)
{
    ...
    OutputPtr = Output;
    fwrite(OutputPtr, sizeof(unsigned char), 4 * n, outFile);
